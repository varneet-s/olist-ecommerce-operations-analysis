...
**Next Step**: Now that I have finished Data Analysis and Visualisation and have proven that the business question I formed is true, I will move forward to map out [gap-analysis →](./5-gap-analysis.md) to show the Business Owner what needs to be done to overcome that gap.
